...
public class Gemstone {
    ...
    protected void init() {
        try {
            Log4jConfigurator.configureQuietly("gemstone2", this.getClass().getClassLoader());
            log.info("Initializing Gemstone2 - Version: " +  api.GetVersion() + " : logging started: " + util.LogInfo());
        } catch (Exception ex) {
