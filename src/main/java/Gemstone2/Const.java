...
public class Const {
    ...
    public static final String OptionsType = "OptionsType";
    public static final String OptionsTypeName = "OptionsTypeName";
    ...
    //General Constants
    public static final String ReleaseName = "Gemstone2";
    public static final String STVFileName = "Gemstone2.xml";
    ...
    public static final String LogFileName = "gemstone2.log4j.properties";
