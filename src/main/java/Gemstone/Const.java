...
public class Const {
    ...
    //General Constants
    public static final String ReleaseName = "Gemstone";
    public static final String STVFileName = "Gemstone.xml";
    public static final String BaseProp = "Gemstone";
    public static final String SageRootProp = "SageRootProp";
